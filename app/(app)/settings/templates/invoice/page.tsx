...
import { Plus, Edit, Trash2, Save, X, Copy, Check, Settings, Code, Monitor } from "lucide-react"
...
const AVAILABLE_VARIABLES: VariableGroup[] = [
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "{{user.status}}", description: "User status" },
    ],
  },
  {
    entity: "Dates & Time",
...
export default function InvoiceTemplatesPage() {
  ...
  const [focusedField, setFocusedField] = useState<"body">("body")
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const url = editingId ? `/api/invoice-templates/${editingId}` : "/api/invoice-templates"
      ...
      <>
        ...
        <div className="space-y-6 mt-6">
          <TitleCard
            ...
            description="Create and edit invoice templates using Blade HTML. Design professional invoice layouts that match your brand and include all necessary information for your customers."
          />
          <Card>
        ...
        {isCreating ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              {/* Left: Invoice Template Editor with Tabs */}
