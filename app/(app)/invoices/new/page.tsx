...
function NewInvoicePageContent() {
  ...
  const serviceLogId = searchParams.get("serviceLogId")
  ...
  const calculateTotals = () => {
    ...
    const discountLineItems = lineItems
      ...
      .reduce((sum, item) => sum + Math.abs(item.total), 0) // Discount items are negative, so use abs
    ...
    try {
      const response = await fetch("/api/invoices", {
        ...
        body: JSON.stringify({
          ...
          serviceLogId: formData.serviceLogId || null,
    ...
    <>
      ...
      <div className="space-y-6 mt-6">
        <TitleCard
          ...
          description="Fill in the invoice information and add line items to create a new invoice for your customer."
        />
                    ...
                    <CardContent className="pt-6 space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                          Select the customer and vehicle for this invoice.
                        </p>
                      </div>
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">The customer receiving this invoice</p>
                        </div>
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">The vehicle associated with this invoice</p>
                        </div>
                      </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 pt-2 border-t">
                          {serviceLogId && (
                            <div className="space-y-2">
                              ...
                              <Input value={serviceLogId} disabled />
                            </div>
                          )}
                        </div>
                      )}
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-sm font-medium">
                            ${lineItems.filter(item => item.type === "labor").reduce((sum, item) => sum + item.total, 0).toFixed(2)}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-muted-foreground">Parts</span>
                          <span className="text-sm font-medium">
                            ${lineItems.filter(item => item.type === "part").reduce((sum, item) => sum + item.total, 0).toFixed(2)}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-muted-foreground">Surcharges</span>
                          <span className="text-sm font-medium">
                            ${lineItems.filter(item => item.type === "fee").reduce((sum, item) => sum + item.total, 0).toFixed(2)}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-sm font-medium text-red-600 dark:text-red-400">
                            -${(lineItems.reduce((sum, item) => {
                              ...
                              return sum + (item.discount || 0)
                            }, 0) + lineItems.filter(item => item.type === "discount").reduce((sum, item) => sum + Math.abs(item.total), 0) + formData.discount).toFixed(2)}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
